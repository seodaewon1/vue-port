...
export const skillText = [
  {
    title: '가능성을 발견하고 실현하다.',
    desc: '저는 항상 새로운 가능성을 찾아내고 이를 실현하는 과정에서 큰 보람을 느낍니다. 대학 시절 다양한 프로젝트와 인턴십을 통해 저는 문제의 본질을 파악하고 그 안에서 잠재력을 발견하는 능력을 키웠습니다. 예를 들어, 데이터 분석 프로젝트에서 기존의 데이터 패턴을 발견하고 이를 통해 새로운 비즈니스 인사이트를 도출해내는 경험을 했습니다. 이러한 과정을 통해 실질적인 변화를 만들어낼 수 있다는 것을 배웠습니다.'
  },
  {
    title: '가능성을 발견하고 실현하다.',
    desc: '저는 항상 새로운 가능성을 찾아내고 이를 실현하는 과정에서 큰 보람을 느낍니다. 대학 시절 다양한 프로젝트와 인턴십을 통해 저는 문제의 본질을 파악하고 그 안에서 잠재력을 발견하는 능력을키웠습니다. 예를 들어, 데이터 분석 프로젝트에서 기존의 데이터 패턴을 발견하고 이를 통해 새로운 비즈니스 인사이트를 도출해내는 경험을 했습니다. 이러한 과정을 통해 실질적인 변화를 만들어낼 수 있다는 것을 배웠습니다.'
  },
  {
    title: '가능성을 발견하고 실현하다.',
    desc: '저는 항상 새로운 가능성을 찾아내고 이를 실현하는 과정에서 큰 보람을 느낍니다. 대학 시절 다양한 프로젝트와 인턴십을 통해 저는 문제의 본질을 파악하고 그 안에서 잠재력을 발견하는 능력을키웠습니다. 예를 들어, 데이터 분석 프로젝트에서 기존의 데이터 패턴을 발견하고 이를 통해 새로운 비즈니스 인사이트를 도출해내는 경험을 했습니다. 이러한 과정을 통해 실질적인 변화를 만들어낼 수 있다는 것을 배웠습니다.'
...
export const contactText = [
  ...
  {
    link: 'mailto:eodnjs1019@naver.com',
    title: 'mail : eodnjs1019@naver.com'
  }
]
